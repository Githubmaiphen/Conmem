...
H:AddLabel("Code By Ngoc Dat Hubi")

H:AddLabel("Ngoc Dat Hub Hub Discord")
H:AddLabel("https://discord.gg/rUKWhEJHf2")
H:AddLabel("Discord: t_Ngoc Dat Hubi")
 

H:AddButton("Youtube Ngoc Dat Hub Hub",function()
setclipboard("https://youtube.com/@Ngoc Dat Hubi0901")
game.StarterGui:SetCore("SendNotification", {
      Icon = "rbxassetid://14161592006";
      Title = "Ngoc Dat Hub Hub", 
      Text = "Copied";
})
end)
